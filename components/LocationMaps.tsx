  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mb-14 max-w-xl px-6 text-center">
        ...
        >
          Kunjungi <em className="italic text-amber-600">Bearasa</em>
        </motion.h2>
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="overflow-hidden rounded-2xl shadow-2xl shadow-stone-900/10 lg:grid lg:grid-cols-2">
          ...
          <motion.div
            ...
            animate={isInView ? "visible" : "hidden"}
            variants={fadeRight}
            className="flex flex-col justify-center bg-stone-900 px-8 py-12 md:px-12"
          >
            {/* Brand */}
            <div className="mb-8">
              <h3
                className="mb-1 text-2xl font-normal text-stone-100"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
                Bearasa
              </h3>
              ...
              <div className="mt-6 h-px w-10 bg-amber-600" />
            </div>
            ...
            >
              ...
              <InfoRow
                ...
                delay={0.25}
              >
                <p className="text-[14px] font-light leading-relaxed text-stone-300">
                  {LOCATION.address}
                  <br />
                  {LOCATION.city}
                </p>
              ...
              >
                <div className="grid grid-cols-1 gap-y-1 sm:grid-cols-2 sm:gap-x-4">
                  {HOURS.map(({ day, time }) => (
                    <div
                      key={day}
                      className="flex justify-between gap-3 text-[13px] font-light"
                    >
              ...
              >
                <a
                  ...
                  className="text-[14px] font-light text-stone-300 transition-colors hover:text-amber-400"
                >
                  {LOCATION.phone}
                </a>
              </InfoRow>
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-stone-700 px-5 py-2.5 text-[13px] font-light text-stone-300 transition-colors hover:border-stone-500 hover:text-stone-100 active:scale-[0.98]"
              >
        ...
        <motion.div
          ...
          className="mx-auto mt-6 h-px w-1/3 origin-center bg-gradient-to-r from-transparent via-amber-700/40 to-transparent"
        />
      </div>
    </section>
  );
