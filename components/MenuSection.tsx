...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    price: "Rp 65.000",
    image:
      "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?q=80&w=700&auto=format&fit=crop",
  ...
  },
  {
    ...
    price: "Rp 75.000",
    image:
      "https://images.unsplash.com/photo-1680674814945-7945d913319c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bmFzaSUyMGdvcmVuZ3xlbnwwfHwwfHx8MA%3D%3D",
  ...
  },
  {
    ...
    price: "Rp 35.000",
    image:
      "https://images.unsplash.com/photo-1579888071069-c107a6f79d82?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDJ8fGljZWQlMjBkcmlua3xlbnwwfDB8MHx8fDA%3D",
  ...
  },
  {
    ...
    price: "Rp 48.000",
    image:
      "https://images.unsplash.com/photo-1551024601-bec78aea704b?q=80&w=700&auto=format&fit=crop",
    badge: { label: "Baru", type: "baru" },
    tags: ["Manis", "Fusion"],
    cats: ["semua", "dessert"],
  },
  {
    ...
    price: "Rp 42.000",
    image:
      "https://images.unsplash.com/photo-1497534446932-c925b458314e?q=80&w=700&auto=format&fit=crop",
...
const BADGE_STYLE: Record<string, string> = {
  populer: "bg-linear-to-r from-[#c4692a] to-[#e8a045] text-[#1a0e06]",
  baru: "bg-[rgba(232,160,69,0.15)] border border-[rgba(232,160,69,0.4)] text-[#e8a045]",
  spesial:
    "bg-[rgba(255,255,255,0.12)] border border-[rgba(255,255,255,0.2)] text-white",
};
    ...
    >
      ...
      <div className="flex flex-col p-5 flex-1">
        ...
        <div className="flex items-center justify-between pt-3.5 mt-4 border-t border-[rgba(232,160,69,0.1)]">
          ...
          <button className="group/btn inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border border-[rgba(232,160,69,0.45)] text-[#e8a045] text-[0.6rem] font-bold tracking-[0.15em] uppercase hover:bg-[rgba(232,160,69,0.12)] hover:border-[#e8a045] transition-all duration-200 whitespace-nowrap">
            Pesan
            <svg
